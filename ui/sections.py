...
def render_suitability_card(score: int, message: str, suggestion: str, condition_emoji: str | None = None, condition_desc: str | None = None) -> None:
    ...
    st.markdown("<h3 style='margin-top:0;'>🎉 Parade Suitability Score</h3>", unsafe_allow_html=True)
...
def render_nasa_section(city: str, date: pd.Timestamp) -> tuple[bool, int, int]:
    ...
    st.markdown("<div class='astro-card'>", unsafe_allow_html=True)
    st.markdown("<h3 style='margin:0;'>📊 Historical Monthly Averages (NASA POWER)</h3>", unsafe_allow_html=True)
...
def render_pollution_stats(city: str, pollution_data: dict) -> None:
    ...
    st.markdown("<div class='astro-card'>", unsafe_allow_html=True)
    st.markdown("<h3 style='margin:0;'>🌫️ Air Pollution Index</h3>", unsafe_allow_html=True)
...
def render_map_panel(center: list | None = None, pin: list | None = None) -> dict | None:
    ...
    """, unsafe_allow_html=True)
    st.markdown("<div class='astro-card map-panel'>", unsafe_allow_html=True)
    if center is None:
        center = [20, 0]
